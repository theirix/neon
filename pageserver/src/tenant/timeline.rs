...
impl Timeline {
            ...
            .swap(true, AtomicOrdering::SeqCst)
        {
            ...
            task_mgr::spawn(
                ...
                async move {
                    ...
                    tokio::select! {
                        calculation_result = self_calculation.calculate_logical_size(init_lsn) => {
    ...
    pub async fn calculate_logical_size(&self, up_to_lsn: Lsn) -> anyhow::Result<u64> {
        ...
        let logical_size = self.get_current_logical_size_non_incremental(up_to_lsn).await?;
    ...
    pub async fn gc(&self) -> anyhow::Result<GcResult> {
